#Desde ayer ando tratando de conectar esto y no me funciona, tengo problemas con mi computador  y la conexion, pero he tratado de avanzar... estoy imprementando este tipo de  
...
#Creacion de un archivo de texto donde se guarda la informacion que agrega el usuario, se utiliza la txt que indica que sera de texto, y con open para crearlo.
